...
OpenAPI-style documentation for the TikTok microservice.
...
info:
  ...
  version: 0.1.0
  description: Processes TikTok uploads and reports results back to Core.
servers:
  - url: /
...
paths:
  ...
  /publish:
    post:
      tags: [Publish]
      summary: Accept a standardized publish payload for TikTok
      operationId: publish
      requestBody:
        required: true
        content:
